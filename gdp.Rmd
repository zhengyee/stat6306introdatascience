...
download.file(fileurl2,destfile='country.csv',method='libcurl')
...
sum(!is.na(unique(gdp2$CountryCode)))
```
...
#5 stands for the highest level and 1 stands for the lowest level
